...
#           'B-receptor-status']
uniqb = ['B-receptor',  'B-stage-value', 'B-grade-value', 
          'B-laterality-value', 'B-htype-value', 
          'B-size-value',  'B-site-value', 'B-receptor-status']
...
file_names = ['label_test_0.txt','label_test_1.txt',
              'label_test_2.txt','label_test_3.txt','label_test_11.txt',
...
df.to_csv('cancerbert_cust_vocab_lenient11.csv',index = False)
dfs.to_csv('cancerbert_cust_vocab_strict11.csv',index = False)
